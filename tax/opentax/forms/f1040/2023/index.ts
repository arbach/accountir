...
import { F1040_2023_CONFIG } from "./config.ts";
...
// CONFIG_BY_YEAR[ctx.taxYear]. So TY2023 reuses the 2025 module graph and
...
export const f1040_2023: FormDefinition = {
  ...F1040_2023_CONFIG,
  inputNodes,
  registry,
  buildMefXml: (pending, filer) =>
    buildMefXml(
      ...
      F1040_2023_CONFIG.mefSchemaVersion,
      F1040_2023_CONFIG.taxYear,
      F1040_2023_CONFIG.formType === "f1040" ? "1040" : F1040_2023_CONFIG.formType,
    ),

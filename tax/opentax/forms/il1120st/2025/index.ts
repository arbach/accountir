...
import { IL1120ST_2025_CONFIG } from "./config.ts";
...
export const il1120st_2025: FormDefinition = {
  ...IL1120ST_2025_CONFIG,
  inputNodes,
  registry,
  // Stub: MeF XML for the IL-1120-ST is not yet implemented.
  buildMefXml: (_pending, _filer) => {
    throw new Error("buildMefXml not yet implemented for il1120st");
  },
  // Stub: PDF rendering for the IL-1120-ST is not yet implemented.

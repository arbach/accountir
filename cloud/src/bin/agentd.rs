...
3. Determine + pull forms: decide which IRS forms the entity needs (schedule_c → f1040sc with the 1040; s_corp → f1120s; partnership → f1065; contractors paid ≥ $600 → f1099nec per payee; depreciation → f4562). Verify anything uncertain with WebSearch on irs.gov. fetch_tax_form pulls each official PDF.
